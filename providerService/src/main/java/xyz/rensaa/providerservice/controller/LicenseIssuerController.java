...
public class LicenseIssuerController {
  ...
  public List<LicenseProposalMessage> getLicenseIssuerProposals(@PathVariable("address") final String address) {
    return licenseService.getLicenseIssuerProposals(address);
  }
